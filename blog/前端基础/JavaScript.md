...
> ```
>
> ![image-20230220184442313](/前端基础/image/image-20230220184442313.png)
...
> ```
>
> ![image-20211017214635189](/前端基础/image/image-20211017214635189.png)
>
> ```js
...
> ```
>
> ![image-20230221095738520](/前端基础/image/image-20230221095738520.png)
...
> ```
>
> ![img](/前端基础/image/2019-01-14-006.png)
>
> ```bash
> ### 浏览器与nodejs 事件循环执行案例
> setTimeout(()=>{
...
> **浏览器处理结果**
>
> ![img](/前端基础/image/2019-01-14-007.gif)
>
> **Nodejs处理结果**
>
> ![img](/前端基础/image/2019-01-14-008.gif)
...
> **webkit的流程**
>
> ![image-20210914235451051](/前端基础/image/image-20210914235451051.png)
>
> **Geoko的流程**
>
> ![image-20210914235521432](/前端基础/image/image-20210914235521432.png)
...
> ```
>
> ![image-20230329111340256](/前端基础/image/image-20230329111340256.png)
>
...
>
> ![image-20230329112327704](/前端基础/image/image-20230329112327704.png)
>
> ##### async / 异步加载脚本
>
> - async 脚本会在加载完毕后执行。
...
>
>    ![image-20230329112729627](/前端基础/image/image-20230329112729627.png)
>
> 2. HTML 解析完之后，async 脚本还未加载完成，那么在HTML解析完毕后就触发 `DOMContentLoaded` 事件。
>
>    ![image-20230329112749177](/前端基础/image/image-20230329112749177.png)
>
> ##### defer / 延时加载脚本
>
...
>
>    ![image-20230329113352649](/前端基础/image/image-20230329113352649.png)
>
> 2. HTML 解析完之后，defer 脚本才加载完，此时会先等待 defer 脚本执行完毕后，才会触发 `DOMContentLoaded` 事件。
>
>    ![image-20230329113418206](/前端基础/image/image-20230329113418206.png)
...
> ```
>
> ![20190128102028682](/前端基础/image/20190128102028682.gif)
...
> ```
>
> ![JS_DOM节点关系表](/前端基础/image/JS_DOM%E8%8A%82%E7%82%B9%E5%85%B3%E7%B3%BB%E8%A1%A8.png)
...
> ```
>
> ![image-20230330174649406](/前端基础/image/image-20230330174649406.png)
...
>
> ![image-20200920125228504](/前端基础/image/image-20200920125228504.png)![image-20200920125235120](/前端基础/image/image-20200920125235120.png)
...
>
> ![image-20210916173138280](/前端基础/image/image-20210916173138280.png)
>
> - offsetTop/offsetLeft：
>   - 调用者：任意元素。(盒子为主)
>   - 作用：距离父系盒子中带有定位的距离。
...
![image-20210916201824135](/前端基础/image/image-20210916201824135.png)
...
> 
>   ![JS_DOM_线程执行](/前端基础/image/JS_DOM_%E7%BA%BF%E7%A8%8B%E6%89%A7%E8%A1%8C.png)
...
> ```
>
> ![c186eeb339b240dd96053c2ccaf2a49e_tplv-k3u1fbpfcp-zoom-in-crop-mark_4536_0_0_0](/前端基础/image/c186eeb339b240dd96053c2ccaf2a49e_tplv-k3u1fbpfcp-zoom-in-crop-mark_4536_0_0_0.webp)
...
![image-20200921181305551](/前端基础/image/image-20200921181305551.png)
...
![image-20210331160948708](/前端基础/image/image-20210331160948708.png)
...
![image-20210915145032445](/前端基础/image/image-20210915145032445.png)

![img](/前端基础/image/153802557624752e85feeed.png)

![jsé¢è¯é¢å¤§åââéå¼ç±»åè½¬æ¢](/前端基础/image/15380256636038c4d44912e.png)

![img](/前端基础/image/1538025799063ed1e9da3cf.png)
...
> ```
> 
> ![恢复删除的水平](/前端基础/image/%E6%81%A2%E5%A4%8D%E5%88%A0%E9%99%A4%E7%9A%84%E6%B0%B4%E5%B9%B3.webp)
>
...
![image-20211013215645301](/前端基础/image/image-20211013215645301.png)
