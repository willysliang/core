...
> ```
> 
>![工厂方法模式](./image/%E5%B7%A5%E5%8E%82%E6%96%B9%E6%B3%95%E6%A8%A1%E5%BC%8F.jpg)
> 
>```ts
> /** 工厂 */
> const factory = function (role) {
...
> ```
>
> ![生成器模式](./image/%E7%94%9F%E6%88%90%E5%99%A8%E6%A8%A1%E5%BC%8F.webp)
>
> ```ts
> /** 汽车零件大小类型约束 */
...
>```
> 
>![适配器模式](./image/%E9%80%82%E9%85%8D%E5%99%A8%E6%A8%A1%E5%BC%8F.jpg)
> 
> ```js
> /** 原有接口（被适配者） */
> class AdapteePlug {
...
>```
>
>![外观模式](./image/%E5%A4%96%E8%A7%82%E6%A8%A1%E5%BC%8F.webp)
>
>```ts
>/** 子系统A */
>class SubSystemA {
...
>```
>
>![享元模式](./image/%E4%BA%AB%E5%85%83%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
...
> ```
>
> ![观察者模式](./image/%E8%A7%82%E5%AF%9F%E8%80%85%E6%A8%A1%E5%BC%8F.jpg)
>
...
>```
>
>![访问者模式](./image/%E8%AE%BF%E9%97%AE%E8%80%85%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
>/** 访问者 */
>class Visitor {
...
>```
>
>![中介者模式](./image/%E4%B8%AD%E4%BB%8B%E8%80%85%E6%A8%A1%E5%BC%8F.webp)
>
>```js
>/** 中介者类 */
>class Mediator {
...
>```
>
>![解释器模式](./image/%E8%A7%A3%E9%87%8A%E5%99%A8%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
>class Context {
>  constructor() {
...
>```
>
>![迭代器模式](./image/%E8%BF%AD%E4%BB%A3%E5%99%A8%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
>/** 迭代器 */
>class Iterator {
...
>```
>
>![备忘录模式](./image/%E5%A4%87%E5%BF%98%E5%BD%95%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
>/** 备忘类 */
>class Memento {
...
>```
>
>![责任链模式](./image/%E8%B4%A3%E4%BB%BB%E9%93%BE%E6%A8%A1%E5%BC%8F.jpg)
>
>```js
...
> ```
>
> ![模板方法](./image/%E6%A8%A1%E6%9D%BF%E6%96%B9%E6%B3%95.jpg)
>
> ```js
> /** 
>  * 抽象父类 - 饮品制作类
